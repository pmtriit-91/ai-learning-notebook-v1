...
import { useLessonProgress } from '../../features/roadmap/hooks/useLessonProgress';
            ...
            >
                <Toolbar sx={{ justifyContent: 'space-between' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Typography
                            variant="h6"
                            sx={{ fontFamily: 'var(--font-heading)', fontWeight: 800, fontSize: '1.1rem' }}
                        >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                        <Typography
                            ...
                            sx={{
                                ...
                                backgroundColor:
                                    mode === 'light' ? 'rgba(29, 78, 216, 0.08)' : 'rgba(59, 130, 246, 0.15)',
                                px: 1.5,
                                py: 0.5,
                                borderRadius: '4px',
                            }}
